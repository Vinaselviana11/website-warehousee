		...
		<div class="login">
				...
				<br>
					<div class="form-group">
						...
						<input type="text" name="username"  class="form-control" value="wil" placeholder="Username" required autofocus />
					</div>
					<div class="form-group">
						<input type="password" name="password" class="form-control" value="wil" placeholder="Password" required autofocus />
					</div>
					<div class="form-group">
